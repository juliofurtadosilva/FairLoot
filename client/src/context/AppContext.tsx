...
const translations = {
  ...
  'dash.navHome': { pt: 'Início', en: 'Home' },
  'dash.navDragHint': { pt: 'Arraste para reordenar as abas', en: 'Drag to reorder tabs' },
  ...
  'admin.tabGeneral': { pt: 'Geral', en: 'General' },
  'admin.tabDiscord': { pt: 'Bot do Discord', en: 'Discord bot' },
  ...
  'admin.discordDigestDesc': {
    pt: 'Nos dias e horário escolhidos, o bot posta no canal escolhido a lista de jogadores com SimC desatualizado (nas dificuldades marcadas abaixo). Clique com o botão direito no canal/cargo no Discord → Copiar ID.',
    en: 'On the chosen days and time, the bot posts the list of players with outdated SimC (for the difficulties checked below) to the chosen channel. Right-click the channel/role in Discord → Copy ID.',
  },
  ...
  'admin.discordDigestDays': { pt: 'Dias da semana', en: 'Days of week' },
  'admin.discordDigestDay.sun': { pt: 'Dom', en: 'Sun' },
  'admin.discordDigestDay.mon': { pt: 'Seg', en: 'Mon' },
  'admin.discordDigestDay.tue': { pt: 'Ter', en: 'Tue' },
  'admin.discordDigestDay.wed': { pt: 'Qua', en: 'Wed' },
  'admin.discordDigestDay.thu': { pt: 'Qui', en: 'Thu' },
  'admin.discordDigestDay.fri': { pt: 'Sex', en: 'Fri' },
  'admin.discordDigestDay.sat': { pt: 'Sáb', en: 'Sat' },
  ...
  'dash.chartNoScoreLegend': { pt: 'Itens atribuídos manualmente, sem pontuar.', en: 'Manually-assigned items that did not count toward score.' },
  'dash.chartViewScore': { pt: 'Com score', en: 'Scored' },
  'dash.chartViewTransmog': { pt: 'Transmog', en: 'Transmog' },
  'dash.chartViewNoScore': { pt: 'Sem score', en: 'No score' },
  'dash.chartViewCaptionTransmog': { pt: 'Itens dados para transmog — não pontuam.', en: 'Items given for transmog — did not count toward score.' },
  'dash.chartSortAsc': { pt: 'Ordem crescente', en: 'Ascending order' },
  'dash.chartSortDesc': { pt: 'Ordem decrescente', en: 'Descending order' },
